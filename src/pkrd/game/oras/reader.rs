...
impl Gen6Reader for PokemonORASReader {
    ...
    const PARENT2_OFFSET_1: usize = 0xC88270;
    const IS_PARENT1_OCCUPIED_OFFSET_1: usize = 0xC88178;
    const IS_PARENT2_OCCUPIED_OFFSET_1: usize = 0xC88268;
    const DAYCARE_TITLE_1: &'static str = "Daycare: Route 117";
    const DAYCARE_FOOTER_1: &'static str = "Select + Right ->";
    ...
    const ID_OFFSET: usize = 0xC81340;
}
