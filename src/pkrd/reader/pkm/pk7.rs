...
struct Pk7 {
    data: [u8; Pk7::STORED_SIZE],
}

impl Pk7 {
    const STORED_SIZE: usize = 260;
    const BLOCK_SIZE: usize = 56;

    fn new(data: [u8; Pk7::STORED_SIZE]) -> Self {
...
mod test {
    ...
    const TEST_EKX: [u8; 260] = [
        ...
        0x0f, 0xa9, 0x96, 0xc6, 0x30, 0xbf, 0x71, 0x96, 0x25, 0xae, 0xf6, 0x8e, 0xe7, 0x20, 0x92,
        0xdf, 0xf0, 0x93, 0xa5, 0xef, 0x3e, 0x63, 0xd9, 0x59, 0x2a, 0x17, 0x04, 0x30, 0x76, 0xec,
        0x86, 0x0f, 0x3c, 0x79, 0x44,
    ];
    ...
    fn should_decrypt() {
        let result: [u8; 260] = [
            ...
            0x31, 0x0b, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x82, 0xfc, 0x3e, 0x10, 0xa0, 0xec,
            0x2a, 0x60, 0xdd, 0xf2, 0x5d, 0xd3, 0xb5, 0xf0, 0x5d, 0xf6, 0x75, 0x16, 0x01, 0x6e,
            0xa7, 0x3d, 0x6f, 0xc2, 0x60, 0xc8, 0xac, 0x60,
        ];
