...
1. Install `launcher/out/pkrd-launcher.cia` or copy `launcher/out/pkrd-launcher.3dsx` to your console's `/3ds` directory
1. Install `out/release/pkrd.cia` to your console
1. Run pkrd-launcher from the hombrew menu (if 3dsx) or home menu (if cia)
